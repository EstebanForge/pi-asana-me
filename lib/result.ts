...
// programmatic callers) can read the exact bytes that reached the Asana REST
...
export interface WriteDetails {
  /** Exact text transmitted to Asana after the user reviewed/edited. */
...
export type AsanaDetails = WriteDetails | undefined;
...
// EXACTLY what reached Asana, plus whether the user edited the draft. Without
